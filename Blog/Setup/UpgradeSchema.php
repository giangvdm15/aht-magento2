    ...
    public function upgrade(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        if (version_compare($context->getVersion(), '1.0.2', '<')) {
            if (! $installer->tableExists('aht_blog_post')) {
                ...
                ->newTable($installer->getTable('aht_blog_post'))
                ...
                $installer->getConnection()->addIndex($installer->getTable('aht_blog_post'), $setup->getIdxName($installer->getTable('aht_blog_post'), [
                    'name',
                    'url_key',
                    'image',
                    'content'
